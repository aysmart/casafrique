...
<head>
    ...
    <title> Event - New Post | Casafrique</title>
                            ...
                            <div class="sparkline8-hd">
                                <div class="main-sparkline8-hd">
                                    <h1>Create New Event</h1>
                                             ...
                                             <input type="text" hidden id="pid" value="-100"/>
                                            ...
                                            <input type="time" id="fromtime" required placeholder="From"   class="form-control" /><br>
                                             </div>
                                             <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3">
                                            <label>Time Frame::To</label>
                                            <input type="time" id="totime" required placeholder="To"   class="form-control" /><br>
                                             </div>
                                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <label>Date of Event</label>
                                            <input type="date" id="eventdate" required placeholder="To"   class="form-control" /><br>
                                             </div>
                                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <label>Event Venue</label>
                                            <input type="text" id="eventvenue" required placeholder="Venue"   class="form-control" /><br>
                                             </div>
