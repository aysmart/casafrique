...
<head>
    ...
    <title> Blog - Edit Post | Casafrique</title>
                ...
                <div class="row">
                    <div class="col"> <!--    -->
                        <div class="sparkline8-list">
                            ...
                            <?php $Ppid=$_GET['pid'];
$query=mysqli_query($con,"select * from blogpost where ID='".$Ppid."'");
$row=$query->fetch_assoc() ?>
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <label>Post Category</label>
                                            <select name="pcateg" id="pcateg">
                                            <option value="News Post" <?php if ($row['Category']=="News Post") echo "selected" ?>>News Post</option>
                                            <option value="Blog Post" <?php if ($row['Category']=="Blog Post") echo "selected" ?>>Blog Post</option>
                                          </select>
                                            <!--  <input type="text" id="pcateg" required placeholder="Category" value="<?php //echo $row['Category']; ?>"  class="form-control" /><br> -->
                                             </div>

                                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <label>Post Title</label>
                                              <input type="text" id="ptitle" required placeholder="Title" value="<?php echo $row['BlogTittle']; ?>"  class="form-control" /><br>
                                             </div>

                                              <input type="text" hidden id="pid" value="<?php echo $_GET['pid']; ?>"/>

                                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                             <label>Post Tags</label>
                                              <input type="text" id="ptags" value="<?php echo $row['PostTags']; ?>" required placeholder="Post Tags" data-role="tagsinput"  class="form-control" />
                                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="tinymce-single responsive-mg-b-30">
                            ...
                            <textarea id="preview-text12" cols="100%" rows="5" fixed><?php echo $row['FirstPrev']; ?></textarea>
                            <div class="alert-title">
                                <h2>Post Content</h2>
                            </div>
