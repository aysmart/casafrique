...
<head>
    ...
    <title>Blog History | Casafrique</title>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Blog <span class="table-project-n">Posts</span> Table</h1>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <?php 
$numrow=1;
$query=mysqli_query($con,"select * from blogpost  ORDER BY DateOfPost DESC");
while ($row=$query->fetch_assoc())
{
         ?>
                                           <tr>
                                                <td><?php echo $numrow; ?></td>
                                                <td><a href="editpost?pid=<?php echo $row['ID']; ?>" ><button>Click To Edit</button></a><br><br><button id="Del-Prod" style="color:#fff; background:red;" data-toggle="modal" data-target="#Del-Information" post-id="<?php echo $row['ID']; ?>" onclick=" document.getElementById('del-id').value=<?php echo $row['ID']; ?>">Delete Post</button></td>
                                                <td><?php echo $row['BlogTittle']; ?></td>
                                                <td><?php echo $row['Category']; ?></td>
                                                <td><?php echo $row['PostedBy']; ?></td>
                                                <td><?php echo $row['PostTags']; ?></td>
                                                <td><?php $Pid=$row['ID'];
                                                $query10=mysqli_query($con,"select * from blogcomments where PostID='".$Pid."'");
