...
<head>
    ...
    <title> Blog - New Post | Casafrique</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Create New Post</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col"> <!--    -->
                        <div class="sparkline8-list">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            ...
                                            <select name="cars" id="pcateg">
                                            <option value="News Post">News Post</option>
                                            <option value="Blog Post">Blog Post</option>
                                          </select>
                                             </div>
                                             <input type="text" hidden id="pid" value="-10"/>
                                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
      ...
      <div class="tinymce-area mg-tb-15">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="tinymce-single responsive-mg-b-30">
                            ...
                            <textarea id="preview-text12" cols="100%" rows="5" fixed></textarea>
                            <div class="alert-title">
                                <h2>Post Content</h2>
                            </div>
        ...
        <div class="dual-list-box-area mg-tb-15">
            <div class="container-fluid">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                                                        <div class="preview-img-pro-ad">
                                                            ...
                                                            <input type="text" id="ptags" required placeholder="Post tags" data-role="tagsinput"  class="form-control" /><br>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <a class="btn btn-primary jscheck" id="download">Process Post</a>
                </div>
            </div>
        </div>
