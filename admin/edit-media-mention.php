...
<head>
    ...
    <title> Media Mention - Edit Post | Casafrique</title>
                ...
                <div class="row">
                    <div class="col"> <!--    -->
                        <div class="sparkline8-list">
                            ...
                            <?php $Ppid=$_GET['pid'];
$query=mysqli_query($con,"select * from mediamention where id='".$Ppid."'");
$row=$query->fetch_assoc() ?>

<input type="text" hidden id="ppid" value="<?php echo $_GET['pid']; ?>"/>
<input type="text" hidden id="pid" value="-300"/>
                                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <label>Title</label>
                                              <input type="text" id="ptitle" required placeholder="Title" value="<?php echo $row['title']; ?>"  class="form-control" /><br>
                                             </div>

                                              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <label>Date of Media Post</label>
                                            <input type="date" id="pdate" required placeholder="Date Of Post" value="<?php echo date("Y-m-d", strtotime($row['postdate']));?>"  class="form-control" /><br>
                                             </div>
                                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <label>Source Name</label>
                                            <input type="text" id="psource" required placeholder="Source Name"  value="<?php echo $row['source']; ?>"  class="form-control" /><br>
                                             </div>
                                             <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                            <label>Post Url</label>
                                            <input type="text" id="purl" required placeholder="Post Url"  value="<?php echo $row['postUrl']; ?>" class="form-control" /><br>
                                             </div>
