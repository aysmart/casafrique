...
<head>
    ...
    <title>Media Mention History | Casafrique</title>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <?php 
$numrow=1;
$query=mysqli_query($con,"select * from mediamention ORDER BY postdate DESC");
while ($row=$query->fetch_assoc())
{
         ?>
                                           <tr>
                                                <td><?php echo $numrow; ?></td>
                                                <td><a href="edit-media-mention?pid=<?php echo $row['id']; ?>" ><button>Click To Edit</button></a><br><br><button id="Del-Prod" style="color:#fff; background:red;" data-toggle="modal" data-target="#Del-Information" post-id="<?php echo $row['id']; ?>" onclick=" document.getElementById('del-id').value=<?php echo $row['id']; ?>">Delete Post</button></td>
                                                <td><?php echo $row['title']; ?></td>
                                                <td><?php echo date(" j M, Y" , strtotime($row['postdate'])) ?></td>
                                                <td><?php echo $row['postUrl']; ?></td>
